# -*- coding: utf-8 -*-
from mantarray_waveform_analysis import magnet_finding, MEMSIC_CENTER_OFFSET, MEMSIC_FULL_SCALE,MEMSIC_MSB, GAUSS_PER_MILLITESLA
from mantarray_file_manager import REFERENCE_SENSOR_READINGS, TISSUE_SENSOR_READINGS,MantarrayH5FileCreator, WellFile
...
def load_h5_files_as_array(recording_name):
    ...
    for module_id in range(1, 25):
        ...
        well_file = WellFile(file_path)
        tissue_data = well_file._h5_file[TISSUE_SENSOR_READINGS][:]
