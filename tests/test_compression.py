...
def test_new_A1_compression(new_A1, generic_beta_1_pipeline_template):
    (
        new_num_samples,
        original_num_samples,
        compressed_per_twitch_dict,
        ...
        original_per_twitch_dict,
        original_aggregate_metrics_dict,
    ) = _get_info_for_compression(new_A1, "new_A1", generic_beta_1_pipeline_template)
...
def test_new_A2_compression(new_A2, generic_beta_1_pipeline_template):
    (
        new_num_samples,
        original_num_samples,
        compressed_per_twitch_dict,
        ...
        original_per_twitch_dict,
        original_aggregate_metrics_dict,
    ) = _get_info_for_compression(new_A2, "new_A2", generic_beta_1_pipeline_template)
...
def test_new_A3_compression(new_A3, generic_beta_1_pipeline_template):
    (
        new_num_samples,
        original_num_samples,
        compressed_per_twitch_dict,
        ...
        original_per_twitch_dict,
        original_aggregate_metrics_dict,
    ) = _get_info_for_compression(new_A3, "new_A3", generic_beta_1_pipeline_template)
...
def test_new_A4_compression(new_A4, generic_beta_1_pipeline_template):
    (
        new_num_samples,
        original_num_samples,
        compressed_per_twitch_dict,
        ...
        original_per_twitch_dict,
        original_aggregate_metrics_dict,
    ) = _get_info_for_compression(new_A4, "new_A4", generic_beta_1_pipeline_template)
...
def test_new_A5_compression(new_A5, generic_beta_1_pipeline_template):
    (
        new_num_samples,
        original_num_samples,
        compressed_per_twitch_dict,
        ...
        original_per_twitch_dict,
        original_aggregate_metrics_dict,
    ) = _get_info_for_compression(new_A5, "new_A5", generic_beta_1_pipeline_template)
...
def test_new_A6_compression(new_A6, generic_beta_1_pipeline_template):
    (
        new_num_samples,
        original_num_samples,
        compressed_per_twitch_dict,
        ...
        original_per_twitch_dict,
        original_aggregate_metrics_dict,
    ) = _get_info_for_compression(new_A6, "new_A6", generic_beta_1_pipeline_template)
