...
FRACTION_MAX_UUID = uuid.UUID("d9758590-9f0d-418d-8913-db3bec2be65f")
...
TIME_DIFFERENCE_UUID = uuid.UUID('58ae3d02-df1b-419c-925a-7a772053bddf')
RELAXATION_TIME_UUID = uuid.UUID('f263e0d0-c55e-49b2-b5a6-93e9a7836be5')
CONTRACTION_TIME_UUID = uuid.UUID('5a92d051-703b-412b-b4e9-968e48331e8b')
